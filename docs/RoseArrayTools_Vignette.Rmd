...
```{r eval=FALSE, include=T}
call_specs(kind_counts_file = "compared_calls_kinds.csv")
```
Running the above function results in the output below. The script counts the number of  "S" "O" "D" and NA are in the entire matrix
```{r eval=FALSE, include=T}
[1] "percent______same 0.109028854404337"
[1] "percent_______one 0.359272009497065"
[1] "percent_different 0.0783920744846818"
[1] "percent________NA 0.453307061613916"
```
