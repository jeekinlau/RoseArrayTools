...
```{r eval=FALSE, include=T}
compare_probes2(data_dat="path_to_file.dat", progress=T)
```

The input file format is the same as compare_probes function. Only need to input the scores.dat file from fitPoly. The function has been updated to use indexing instead of loops thus around 20X faster than the first version. Also a bug was found where incorrect probes were sometimes being compared.


## 'compare_probes' (DEFUNCT DO NOT USE)

**IMPORTANT** this function is now defunct. The ideas behind the description are still valid. However there is a small error that introduces a big error. Please use the compare_probes2 function. Function is still here just for documentation.
...
![image of input file and output file formats no separator](C:/Users/Jeeki/Dropbox/Projects/R_Packages/Dosage_to_ACGT/DoseToACGT/Screenshot 2021-04-02 151131.png)

![image of input file and output file formats with separator="|"](C:/Users/Jeeki/Dropbox/Projects/R_Packages/Dosage_to_ACGT/DoseToACGT/Screenshot 2021-04-23 104929.png)
...
![image of select_genotypes input file ](C:/Users/Jeeki/Dropbox/Projects/R_Packages/Dosage_to_ACGT/DoseToACGT/Screenshot 2021-04-29 111127.png)
...
![input and output files ](C:/Users/Jeeki/Dropbox/Projects/R_Packages/Screenshot 2021-05-21 100729.png)
...
![input and output files](C:/Users/jeeki/Dropbox/Projects/R_Packages/fitpoly_to_mappoly_ready.png)
...
![Input and output files](C:/Users/jeeki/Dropbox/Projects/R_Packages/fitpoly_to_GWASpoly.png)
